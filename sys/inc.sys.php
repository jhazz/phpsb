...
function alphaBackgrounds(){
  ...
  function PutVars(){
    ...
    $this->hasPutVars=1;
    print "<script>PublicURL='$cfg[PublicURL]';SkinURL='$SkinURL';sysPubURL='$cfg[PublicURL]/sys';</script>\n";
  }
/*
...
*/
  ...
  function InitPage($Options=false)
    {
...
#		print '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">'; # СТРОГИЙ!
	
		print '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.1//EN" "http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd">';
    print '<html xmlns="http://www.w3.org/1999/xhtml">';
    if ($Options['PutVars']) $this->PutVars();
    $this->hasBodyPut=true;
    print "\n\n<script src='$cfg[PublicURL]/sys/disp.js'></script>\n\n";
